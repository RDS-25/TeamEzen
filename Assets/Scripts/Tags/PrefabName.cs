...
public class PrefabName
{
    ...
    public const string STR_SKILL_SLOT              = "SelectingSkill";
    ...
    public const string STR_BOSS_MONSTER            = "BossEnemy";

    public const string STR_BASIC_EFFECT    = "CharAr_Basic_Effect";
